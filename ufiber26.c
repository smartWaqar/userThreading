...
UserThreading *UserThreadingVec1 __attribute__( ( aligned ( 128 ) ) );
UserThreading *UserThreadingVec2 __attribute__( ( aligned ( 128 ) ) );
...
void pfc(){
    ...
    UserThreadingVec2->buf2 = UserThreadingVec1->buf; 
    UserThreadingVec1->buf2 = UserThreadingVec2->buf;
    ...
    for (int i=0; i < 10000000; i++){
      ...
      //Yield(&UserThreadingVec[threadId]);
        ...
        if (threadId == 0)
          Yield(UserThreadingVec1);
        else
          Yield(UserThreadingVec2);
    ...
    UserThreadingVec1->buf->context.mxcsr = 0;
    UserThreadingVec1->sp_exit_check = true;



    UserThreadingVec2->buf->context.mxcsr = 0;
    UserThreadingVec2->sp_exit_check = true;
...
void *mpthread1(void *arg){
    ...
    UserThreadingVec1 = malloc(sizeof(UserThreading));
    UserThreading_Init(UserThreadingVec1, 0);
    makeThread(UserThreadingVec1, pfc);
...
void *mpthread2(void *arg){
    ...
    UserThreadingVec2 = malloc(sizeof(UserThreading));
    UserThreading_Init(UserThreadingVec2, 1);
